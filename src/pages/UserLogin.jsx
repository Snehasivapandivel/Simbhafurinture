    ...
    <div>
      <div className="container mt-4 ">
        <div className="row justify-content-center mt-3 ms-0 me-0 pb-3 ">
          <div className="card shadow col-md-6 rounded-2" style={{ width: "27rem" }}>
            <div className="row head p-2  head rounded-2">
              <h2 className="text-center text-white ">Simbha Furniture</h2>
            </div>
            ...
            <div className="card-body mt-2">
              <div className="text-center">
                <button type="button" className="btn  w-50 butto" onClick={signup}>Signup</button>
                <button type="button" className="btn  w-50 butto" onClick={signin}>Signin</button>
